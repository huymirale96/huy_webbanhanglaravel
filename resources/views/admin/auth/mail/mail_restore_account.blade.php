...
<div class="container">
    ...
    <div class="content">
        <p>Bạn nhận được mail này vì Super Admin đã khôi phục tài khoản của bạn. Bạn phải xác thực tài khoản để có thể tiếp tục truy cập hệ thống.</p>
        <p>Bạn vui lòng nhấn vào nút bên dưới để tiến hành xác thực. Lưu ý, đường link chỉ tồn tại trong vòng 24h</p>
        <center><a href="{{ route('admin.check_token', $token) }}" class="btn-verify">Xác thực</a></center>
        <p>Xin cảm ơn!</p>
