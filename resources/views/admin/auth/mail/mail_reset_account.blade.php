...
<div class="container">
    ...
    <div class="content">
        <p>Bạn nhận được mail này vì Super Admin đã đặt lại tài khoản của bạn. Bạn phải đặt lại tài khoản để có thể tiếp tục sử dụng hệ thống.</p>
        <p>Bạn vui lòng nhấn vào nút bên dưới để tiến hành đặt lại. Lưu ý, đường link chỉ tồn tại trong vòng 24h</p>
